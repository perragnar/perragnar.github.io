...
![Ändrad CSS-fil](/assets/postfiles/git-aterstall-git-discard-css-change-1.png)

Så här ser `git status` ut efter ändringen.

![Git status för ändrad CSS-fil](/assets/postfiles/git-aterstall-git-discard-css-change-2.png)
...
![Git status för ändrade filer](/assets/postfiles/git-aterstall-git-discard-files-change-1.png)
...
![Git diff på ändrade filer](/assets/postfiles/git-aterstall-git-discard-files-change-2.png)
...
![Git log](/assets/postfiles/git-aterstall-git-discard-files-change-3.png)
...
![Git log](/assets/postfiles/git-aterstall-git-discard-files-change-4.png)
