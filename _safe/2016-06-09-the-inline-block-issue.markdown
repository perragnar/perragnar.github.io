...
![Meny](/assets/postfiles/inline-block-issue-fig-1.png)
...
![4 pixlar marginal](/assets/postfiles/inline-block-issue-fig-2.png)

## Ta kontroll över marginalerna!

För att få bort marginalen kan man göra på olika sätt, bra eller dåliga får du avgöra.

![Ta kontroll över marginalerna](/assets/postfiles/inline-block-issue-fig-3.png)
